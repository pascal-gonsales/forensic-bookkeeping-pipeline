...
def build_pdf():
    ...
    cc_data = [
        ...
        ['TD Visa *8371', fmt(645608), fmt(306848), fmt(952456)],
        ['TD Visa *0394', fmt(256175), fmt(292593), fmt(548768)],
        ['Desjardins Visa *7006', fmt(242558), fmt(50599), fmt(293157)],
        ['BDC Mastercard *3298', fmt(13146), fmt(41512), fmt(54658)],
    ...
    todo = [
        ...
        ['3', 'Factures Damen (split par resto)', fmt(370000), 'Haute'],
        ['4', 'Factures Ferro/Frandon/Supplier Delta', fmt(76000), 'Moyenne'],
    ...
    story.append(Spacer(1, 18))
    story.append(Paragraph('Source: Pipeline forensic bookkeeping V3.2 — Relevés bancaires (CSV+PDF), Relevés CC personnels (PDF+RALF-CC), Factures Quickbooks, A/R Aging Summary.', note_style))
